...
VAR1="32 128 64 64 128"
VAR2="32 128 64 128 64"
VAR3="32 128 64 128 64"
...
fun()
{
    ...
    for i in $VAR1; do
        echo command "$i" "$1"
        # For Basic DQN
        python main.py --seed=$MYSEED --test_mode=TRAIN --agent_mode=SIMPLE --network_mode=SIMPLE --name=DQN --fc1_dims=$i --fc2_dims=$1 --fc3_dims=$1
